...
export type ButtonPropType = {
  ...
  isFalseAnswer?: string | undefined | null | boolean;
    ...
    >
      ...
      >
        {!filteredData && path === "/" ? (
          ...
          <div
            className={`${buttonStyle} w-10 h-10 rounded-[6px] text-[18px] leading-[18px] font-medium flex items-center justify-center md:w-[56px] md:h-[56px] md:rounded-[12px] lg:rounded-[8px] md:text-[28px] md:leading-[28px] text-[#626C7F "hover:bg-[#F6E7FF] transition duration-300 ease-in-out`}
          >
            {" "}
            {label}{" "}
          </div>
